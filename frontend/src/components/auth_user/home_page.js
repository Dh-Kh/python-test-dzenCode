...
function HomePage() {
    ...
    useEffect(() => {
        api.get('http://127.0.0.1:8000/api/display_model/')
      		.then(response => {
              ...
              <div className="card-content has-text-centered">
                {userObject.map((data, index) => (
                  <div key={index}>
                    ...
                    <p className="text-muted mb-4">{data.username} <span className="mx-2">|</span>Home Page</p>
                    <Link to="/comments">
                    ...
                    <div className="columns is-centered mt-5 mb-2">
                      <div className="column is-narrow">
                        <p className="mb-2 is-size-4">{data.email}</p>
